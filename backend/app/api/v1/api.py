...
api_router.include_router(
    rental_configs.router, prefix="/rental-configs", tags=["rental_configs"]
)
api_router.include_router(payments.router, prefix="/payments", tags=["payments"])
api_router.include_router(
    payment_cards.router, prefix="/payment-cards", tags=["payment_cards"]
)
api_router.include_router(feedbacks.router, prefix="/feedbacks", tags=["feedbacks"])
api_router.include_router(
    revenue_stats.router, prefix="/revenue-stats", tags=["revenue_stats"]
)
api_router.include_router(
